...
export class ResetPasswordComponent implements OnInit {
  ...
  onSubmit(): void {
    if (this.resetPasswordForm.valid) {
      ...
      this.http.post(`${this.apiUrl}/forgot-password/reset-password/${this.token}`, { newPassword })
        .subscribe(
          () => {
          ...
          error => {
            this.messageService.add({ severity: 'error', summary: 'Error', detail: 'Failed to reset password. Token might be expired or invalid.' });
          }
        );
    }
  }
